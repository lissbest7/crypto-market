...
const Table = ({ data }) => {
  ...
  const getCommissionBackgroundColor = (commission) => {
    ...
    if (commissionValue > 0) {
      return "bg-[#2196543c] text-[#219653] text-[10px] leading-[22px] font-semibold"; 
    } else if (commissionValue < 0) {
      return "bg-[#eb575738] text-[#EB5757] text-[10px] leading-[22px] font-semibold"; 
    }
    return "";
  };
  ...
  const getTextColor = (value) => {
    ...
    return numericValue >= 0 ? "text-[#219653]" : "text-[#EB5757]"; 
  };
