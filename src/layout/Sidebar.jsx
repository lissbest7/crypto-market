    ...
    <>
      ...
      >
        <div className="flex-col items-stretch min-h-full flex-nowrap px-0 relative">
          <NavLink to="/dashboard" className="mt-[26px] text-center w-full inline-block">
            <img
          ...
          <div className="flex flex-col">
            <ul className="flex-col min-w-full flex gap-4 list-none mt-[71px]">
              ...
              <li className="rounded-lg mb-4 hover:text-[#0060FF]">
                <button  onClick={handleLogout} className="flex items-center gap-[14px] text-[18px] leading-[21px] font-medium px-[29px] py-[14px] rounded-lg">
                  <>
