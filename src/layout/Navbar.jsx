...
export default function Navbar({ showSidebar, setShowSidebar }) {
    ...
    const menuItems = [
        { label: 'My Account', href: '/profile', image: user },
        { label: 'Admin Panel', href: '#', image: adminIcon },
        { label: 'Vendor Panel', href: '#', image: adminIcon },
        { label: 'Logout', href: '/', image: logout },
    ];
            ...
            <div className="container max-w-full mx-auto flex items-center justify-between">
                <div className="md:hidden">
                    <button onClick={() => setShowSidebar("left-0")}>
                        <svg className="collapse-icon pointer" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 13H22M4 7H22M4 19H16" stroke="#898989" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                    </button>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex relative items-center justify-between px-5 py-[7px] rounded-[12px] bg-[#F2F8FF] dark:bg-[#131313] w-[256px]">
                            <div className="flex gap-2.5 items-center">
                                ...
                                <div>
                                    <p className="text-[13px] font-medium text-[#1F1F1F] dark:text-[#E0E0E0]">Vahid Sharifzade</p>
                                    <p className="text-[11px] font-medium text-[#5E6E78]">vahidsrifzad@gmail.com</p>
                                </div>
                            </div>
